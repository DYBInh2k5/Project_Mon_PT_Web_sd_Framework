...
@section('content')
    ...
    <div class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-6 z-1">
        ...
        <div class="mx-auto w-full max-w-2xl text-center">
            ...
            <h1 class="mt-6 text-5xl font-bold text-gray-900 dark:text-white sm:text-6xl">Ban không co quyền vao trang nay</h1>
            <p class="mt-4 text-base text-gray-600 dark:text-gray-400 sm:text-lg">
                Middleware da chan truy cap vi tai khoan hien tai không dung role yeu cau.
            </p>
